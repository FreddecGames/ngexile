...
from .views import fleet_cargo
from .views import fleet_list
from .views import fleet_move
...
from .views import planet_ground
...
urlpatterns = [
	...
	path('fleet-cargo/', fleet_cargo.View.as_view()),
	path('fleet-list/', fleet_list.View.as_view()),
	path('fleet-move/', fleet_move.View.as_view()),
	...
	path('planet-ground/', planet_ground.View.as_view()),
