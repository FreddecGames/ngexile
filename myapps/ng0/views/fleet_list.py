    ...
    def get(self, request, *args, **kwargs):
        ...
        if action == "setcat":
            ...
            if result:
                ...
                self.tpl = getTemplate(request, "ng0/fleets-handler")

                self.tpl.setValue("id", fleetId)
                self.tpl.setValue("old", oldCat)
                self.tpl.setValue("new", newCat)
                
                self.tpl.Parse("fleet_category_changed")
        ...
        #---
            ...
            if isValidCategoryName(name):
                ...
                if result:
                    ...
                    self.tpl.setValue("id", result)
                    self.tpl.setValue("label", name)
                    self.tpl.Parse("category")
                ...
                self.tpl.Parse("category_name_invalid")
        ...
        self.tpl = getTemplate(request, "ng0/fleets")
        ...
        self.tpl.setValue("categories", categories)
