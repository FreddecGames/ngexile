...
class View(GetView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        self.tpl = getTemplate(request, "ng0/map")
        ...
        self.tpl.setValue("galaxy", galaxy)
        self.tpl.setValue("sector", sector)
        ...
        if galaxy == "":
            ...
            self.tpl.setValue("galaxies", galaxies)
        ...
        #---
            ...
            if mapgalaxy == None: return HttpResponseRedirect('/ng0/map')
            self.tpl.setValue("mapgalaxy", mapgalaxy)
        ...
        #---
            ...
            self.tpl.setValue("sector0", self.getSector(sector,-1,-1))
            self.tpl.setValue("sector1", self.getSector(sector, 0,-1))
            self.tpl.setValue("sector2", self.getSector(sector, 1,-1))
            self.tpl.setValue("sector3", self.getSector(sector, 1, 0))
            self.tpl.setValue("sector4", self.getSector(sector, 1, 1))
            self.tpl.setValue("sector5", self.getSector(sector, 0, 1))
            self.tpl.setValue("sector6", self.getSector(sector,-1, 1))
            self.tpl.setValue("sector7", self.getSector(sector,-1, 0))
            ...
            self.tpl.setValue("locations", planets)
            ...
            if radarstrength > 0:
                ...
                self.tpl.setValue("movings", movings)
                self.tpl.setValue("enterings", enterings)
                self.tpl.setValue("leavings", leavings)

                #---
                
                self.tpl.Parse("radar") 
