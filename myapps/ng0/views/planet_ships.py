...
class View(GetPostView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if request.GET.get("recycle", "") != "":
            ...
            self.tpl = getTemplate(request, "ng0/shipyard-recycle")
            ...
            self.tpl = getTemplate(request, "ng0/shipyard")
        ...
        queues = []
        self.tpl.setValue("queues", queues)
        
        underconstructions = []
        self.tpl.setValue("underconstructions", underconstructions)
