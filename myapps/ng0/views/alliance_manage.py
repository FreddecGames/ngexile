...
class View(BaseView):
    ...
    def displayOptions(self, cat):
        ...
        content = getTemplateContext(self.request, "alliance-manage")
    ...
    def SaveGeneral(self):
        ...
        if logo != "" and not isValidURL(logo):
            ...
            dbQuery("UPDATE alliances SET logo_url=" + strSql(logo) + ", description=" + strSql(description) + " WHERE id = " + str(self.AllianceId))
    ...
    def SaveMotD(self):
        ...
        # save updated information
        dbQuery("UPDATE alliances SET defcon=" + str(defcon) + ", announce=" + strSql(MotD) + " WHERE id = " + str(self.AllianceId))
        self.changes_status = "done"
