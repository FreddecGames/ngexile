...
class View(GetView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        self.tpl = getTemplate(request, "ng0/ranking-players")
        ...
        self.tpl.setValue('col', col)
        
        #---

        if request.GET.get('r', '') != '': reversed = not reversed
        else: self.tpl.Parse('r' + str(col))
        ...
        self.tpl.setValue("TenthUserScore", TenthUserScore)
        ...
        if nb_pages > 1:
            ...
            self.tpl.setValue("page_displayed", offset + 1)
            self.tpl.setValue("page_first", offset * displayed + 1)
            self.tpl.setValue("page_last", min(size, (offset + 1) * displayed))
        ...
        self.tpl.setValue("players", rows)
