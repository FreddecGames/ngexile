...
class View(GetView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        self.tpl = getTemplate(request, "ng0/reports")

        #---

        self.tpl.setValue("ownerid", self.userId)

        #---

        cat = ToInt(request.GET.get("cat", ""), 0)
        self.tpl.setValue("cat", cat)
        ...
        reports = []
        self.tpl.setValue("reports", reports)
        ...
        for row in rows:
            ...
            self.tpl.setValue("tabnav_" + str(row['type']) + "00_newreports", row['count'])

            total_newreports += row['count']
        
        self.tpl.setValue("total_newreports", total_newreports)
