...
class View(BaseView):
    ...
    def DisplayFleet(self, fleetid):
        ...
        content = getTemplateContext(self.request, "fleet-ships")
        ...
        query = "SELECT id, name, attackonsight, engaged, size, signature, speed, remaining_time, commanderid, commandername," + \
                ...
                " FROM vw_fleets WHERE ownerid="+str(self.profile['id'])+" AND id="+str(fleetid)
    ...
    def TransferShips(self, fleetid):
        ...
        for i in shipsArray:
            ...
            if quantity > 0:
                oConnExecute("SELECT sp_transfer_ships_to_fleet(" + str(self.profile['id']) + "," + str(fleetid) + "," + str(shipid) + "," + str(quantity) + ")")
        ...
        for i in shipsArray:
            ...
            if quantity > 0:
                ...
                oConnExecute("SELECT sp_transfer_ships_to_planet(" + str(self.profile['id']) + "," + str(fleetid) + "," + str(shipid) + "," + str(quantity) + ")")
