...
class View(GlobalView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        content.setValue("orientation", self.profile["orientation"])
        ...
        content.setValue("stat_rank", row["stat_rank"])
        content.setValue("stat_players", row["stat_players"])
        ...
        content.setValue("stat_rank_battle", row["stat_rank_battle"])
        ...
        content.setValue("date", row['date'])
        content.setValue("stat_colonies", row['stat_colonies'])
        content.setValue("stat_prod_ore", row['stat_prod_ore'])
        content.setValue("stat_prod_hydrocarbon", row['stat_prod_hydrocarbon'])
        ...
        content.setValue("stat_workers", row['workers'] + row2['workers'])
        content.setValue("stat_scientists", row['scientists'] + row2['scientists'])
        content.setValue("stat_soldiers", row['soldiers'] + row2['soldiers'])
