...
class View(GlobalView):
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        if action == 'buy':
            ...
            for planet in planets:
                ...
                if ore > 0 or hydrocarbon > 0:
                    ...
                    oConnDoQuery('SELECT sp_buy_resources(' + str(self.UserId) + ',' + str(planetId) + ',' + str(ore * 1000) + ',' + str(hydrocarbon * 1000) + ')')
        ...
        query = 'SELECT planets.id, planets.name, planets.galaxy, planets.sector, planets.planet, planets.floor,' + \
                ...
                ' (sp_get_resource_price(' + str(self.UserId) + ', planets.galaxy)).buy_ore::real AS price_ore,' + \
                ' (sp_get_resource_price(' + str(self.UserId) + ', planets.galaxy)).buy_hydrocarbon::real AS price_hydrocarbon' + \
