...
class GlobalView(BaseMixin, View):
    ...
    def CheckSessionValidity(self):
        ...
        # if a user tries to username multiple times, the first sessions are abandonned
        ...
        query = "SELECT username, privilege, lastlogin, credits, lastplanetid, deletion_date, score, planets, previous_score," +\
                ...
                "lcid, security_level, (SELECT username FROM users WHERE id=" + str(self.UserId) + ") AS username" +\
                " FROM users" +\
