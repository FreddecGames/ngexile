...
class View(BaseView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        tpl.set('production_ore', int(totalOre))
        tpl.set('production_energy', int(totalEnergy))
        tpl.set('production_hydrocarbon', int(totalHydrocarbon))

        #---
        
        self.bonuses = []
        tpl.set('bonuses', self.bonuses)
        ...
        tpl.set('bonus_production_ore', int(row['ore_production'] - totalOre))
        tpl.set('bonus_production_hydrocarbon', int(row['hydrocarbon_production'] - totalHydrocarbon))
        tpl.set('bonus_production_energy', int(row['energy_production'] - totalEnergy))

        tpl.set('total_production_ore', int(row['ore_production']))
        tpl.set('total_production_hydrocarbon', int(row['hydrocarbon_production']))
        tpl.set('total_production_energy', int(row['energy_production']))
