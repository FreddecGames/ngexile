                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header" data-bs-toggle="collapse" data-bs-target="#stats_content">
                            <span class="fs-6">Statistiques de votre empire - {{ date }}</span>
                        </div>
                                    ...
                                    <div class="col-5">
                                        <div class="row g-1 flex-column">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <img src="/img/interface/credits.gif" class="res" data-bs-toggle="tooltip" data-bs-title="Crédits" width="16px" height="16px">
                                    ...
                                    <div class="col-4">
                                        <div class="row g-1 flex-column">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <img src="/img/interface/ore.gif" class="res" data-bs-toggle="tooltip" data-bs-title="Minerai" width="16px" height="16px">
                                                {{ stat_prod_ore|intcomma }}
                                            </div>
                                            <div class="col-12">
                                                <span class="text-normal me-2">Hydrocarbure par heure</span>
                                                <img src="/img/interface/hydrocarbon.gif" class="res" data-bs-toggle="tooltip" data-bs-title="Hydrocarbure" width="16px" height="16px">
                                    ...
                                    <div class="col-3">
                                        <div class="row g-1 flex-column">
                                            <div class="col-12">
                                                ...
                                                <img src="/img/interface/workers.gif" class="res" data-bs-toggle="tooltip" data-bs-title="Travailleur" width="16px" height="16px">
                                                {{ stat_workers|intcomma }}
                                            </div>
                                            <div>
                                                <span class="text-normal me-2">Scientifiques</span>
                                                <img src="/img/interface/scientists.gif" class="res" data-bs-toggle="tooltip" data-bs-title="Scientifique" width="16px" height="16px">
                                                {{ stat_scientists|intcomma }}
                                            </div>
                                            <div>
                                                <span class="text-normal me-2">Soldats</span>
                                                <img src="/img/interface/soldiers.gif" class="res" data-bs-toggle="tooltip" data-bs-title="Soldat" width="16px" height="16px">
                                                {{ stat_soldiers|intcomma }}
                                            </div>
                                            <div>
                                                <span class="text-normal me-2">Points de prestige</span>
                                                <img src="/img/interface/prestige.gif" class="res" data-bs-toggle="tooltip" data-bs-title="Prestige" width="16px" height="16px">
                                    ...
                                    <div class="col">
                                        {% if fleet.owner_relation == 2 %}
                                            {% if fleet.attackonsight %}
                                                <img src="/img/interface/stance_attack.gif"
                                                     class="stance"
                                                     data-bs-toggle="tooltip" data-bs-title="Mode attaque"
                                                     width="10"
                                                     height="10">
                                            {% else %}
                                                <img src="/img/interface/stance_defend.gif"
                                                     class="stance"
                                        ...
                                        {% endif %}
                                        <span class="ms-2">{{ sig(fleet.signature) }}</span>
                                    </div>
                                    <div class="col-auto">
                                        {% if fleet.f_planetid %}{{ putplanet(fleet.f_planetid, fleet.f_planetname, fleet.f_g, fleet.f_s, fleet.f_p, fleet.f_relation) }}
                                        {% else %}<span class="text-normal">???</span>{% endif %}
                                        <i class="fa-fw fas fa-long-arrow-alt-right mx-2 text-normal"></i>
                                        {{ putplanet(fleet.t_planetid, fleet.t_planetname, fleet.t_g, fleet.t_s, fleet.t_p, fleet.t_relation) }}
                                    </div>
                                    <div class="col-auto text-end" style="width:75px;">
                                        <span class="text-yellow">{{ putcountdown1(fleet.time, "Terminé", "/s03/empire-view/") }}</span>
                                    </div>
                                </div>
                            </div>
                        {% empty %}
                        ...
                        <div class="card-body">
                            {% if research %}
                                <div class="row gx-3">
                                    ...
                                    <div class="col-auto"><span class="text-yellow">{{ putcountdown1(research.time, "Terminé", "/s03/tech-list/") }}</span></div>
                                </div>
                            {% else %}
                                            ...
                                            {% for building in item.buildings %}
                                                <div class="col-12">
                                                    <div class="row gx-3 justify-content-end">
                                                        ...
                                                        <div class="col-auto text-end" style="width:75px;"><span class="text-yellow">{{ putcountdown1(building.time, "Terminé", "/s03/planet-buildings/?planet=item.planetid#building.buildingid") }}</span></div>
                                                    </div>
                                                </div>
                                            {% empty %}
                                        ...
                                        <div class="col-auto">
                                            ...
                                            {% elif item.shipid %}
                                                <div class="row gx-3 justify-content-end">                                        
                                                    ...
                                                    <div class="col-auto text-end" style="width:65px;"><span class="text-yellow">{{ putcountdown1(item.time, "Terminé", "/s03/planet-ships/?planet=item.planetid#item.shipid") }}</span></div>
                                                </div>
                                            {% else %}
